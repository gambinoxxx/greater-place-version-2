...
// Server-side filter: exact (case-insensitive) category, and a case-insensitive "contains" on
// title or excerpt. Both are optional and combine with AND.
...
export const getPostBySlug = cache((slug) =>
  slug.includes('\u0000') || slug.length > 200 ? null : prisma.post.findUnique({ where: { slug } })
)
